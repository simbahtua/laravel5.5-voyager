                    ...
                    <div class="col-md-8" id="main-content">
                        <div class="widget-post">
                            <div class="post-heading">
                                <h1 class="post-title">Pedoman Peringatan Hari Kesaktian Pancasila Tahun 2017</h1>
                        ...
                        <div class="panel panel-default panel-theme">
                            ...
                            <div class="panel-body">
                                <ul class="sidebar-list">
                                    <li>
                                        <a href="#" title="AKBP Asfuri Resmi Jabat Kapolres Malang Kota">AKBP Asfuri Resmi Jabat Kapolres Malang Kota</a>
                                        <ul class="meta">
                                            <li class="post-meta-date"><i class="fa fa-clock-o"></i>Selasa, 26 September 2017 16:25 WIB</li>
                                        </ul>
                                    </li>
                                    ...
                                    <li>
                                        <a href="#" title="Lagi, Kota Malang Raih Penghargaan Natamukti">Lagi, Kota Malang Raih Penghargaan Natamukti</a>
                                        <ul class="meta">
                                            <li class="post-meta-date"><i class="fa fa-clock-o"></i>Selasa, 26 September 2017 16:25 WIB</li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a href="#" title="Bakesbangpol Kota Malang Sosialisasikan Regulasi Pilkada 2018">Bakesbangpol Kota Malang Sosialisasikan Regulasi Pilkada 2018</a>
                                        <ul class="meta">
                                            <li class="post-meta-date"><i class="fa fa-clock-o"></i>Selasa, 26 September 2017 16:25 WIB</li>
                                        </ul>
                                    </li>
