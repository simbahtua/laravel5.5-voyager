...
return [
    'date' => [
        ...
        'this_week' => 'Minggu Sekarang',
        'this_year' => 'Tahun Sekarang',
    ],
    ...
    'generic' => [
        ...
        'actions'                => 'Aksi',
        'add'                    => 'Tambah',
        'add_folder'             => 'Tambah Direktori',
        'add_new'                => 'Tambah Baru',
        'all_done'               => 'Proses Selesai',
        'are_you_sure'           => 'Apakah Anda Yakin',
        'are_you_sure_delete'    => 'Apakah Anda Yakin akan menghapus data ini',
        'auto_increment'         => 'Auto Increment',
        'browse'                 => 'Browse',
        'builder'                => 'Builder',
        'bulk_delete'            => 'Hapus',
        'bulk_delete_confirm'    => 'Ya, Hapus Data',
        'bulk_delete_nothing'    => 'Anda Belum Memilih Data Yang Akan dihapus',
        'cancel'                 => 'Batal',
        ...
        'default'                => 'Default',
        'delete'                 => 'Hapus',
        'delete_confirm'         => 'Ya, Hapus Data ini',
        'delete_question'        => 'Apakah Anda Yakin akan menghapus data ini',
        'delete_this_confirm'    => 'Ya, Hapus Data ini',
        'deselect_all'           => 'Batalkan Pilihan',
        'download'               => 'Download',
        'edit'                   => 'Ubah',
        'email'                  => 'E-mail',
        'error_deleting'         => 'Maaf, Penghapusan Data Gagal',
        'exception'              => 'Pengecualian',
        'featured'               => 'Featured',
        'field_does_not_exist'   => 'Kolom data tidak ditemukan',
        ...
        'select_group'           => 'Pilih Grup yang ada atau buat grup baru',
        'settings'               => 'Settings',
        'showing_entries'        => 'Menampilkan :from ke :to dari :all Data|Menampilkan :from s/d :to of :all Data',
        'submit'                 => 'Submit',
        'successfully_added_new' => 'Penambahan Data Berhasil',
        'successfully_deleted'   => 'Penghapusan Data Berhasil',
        'successfully_updated'   => 'Pembaruan Data Berhasil',
        'timestamp'              => 'Timestamp',
        'title'                  => 'Title',
        'type'                   => 'Type',
        'unsigned'               => 'Unsigned',
    ...
    'profile' => [
        ...
        'edit_user'     => 'Edit User',
        'password'      => 'Password',
        'password_hint' => 'Kosongkan input apabila tidak ada perubahan data',
        'role'          => 'Role',
        'user_role'     => 'Hak Aksess',
    ],
    ...
    'media' => [
        'add_new_folder'         => 'Tambah Direktori Baru',
        'audio_support'          => 'Browser Anda Tidak mendukung elemen audio.',
        'create_new_folder'      => 'Buat Direktori Baru',
        'delete_folder_question' => 'Menghapus direktori akan menghapus semua file yang ada di dalamnya',
        'destination_folder'     => 'Direktori Tujuan',
    ...
    'datatable' => [
        ...
        'sInfoEmpty'      => 'Menampilkan 0 s/d 0 dari 0 entries',
